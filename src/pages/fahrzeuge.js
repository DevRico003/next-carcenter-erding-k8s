  ...
  useEffect(() => {
    ...
    if (fuelTypeFilter.length > 0) {
      result = result.filter((car) =>
        car.fuelTypes.some((fuelType) =>
          fuelTypeFilter.includes(fuelType.trim())
        )
      );
    }
              ...
              <div className="row mb-40">
                <div className="col-lg-12">
                  <div className="show-item-and-filter">
                    <p>
                      Es gibt <strong>{filteredCars.length}</strong> verfügbare NEUE ÄNDERUNG
                      Autos.
                    </p>
                  </div>
                </div>
                            ...
                            <ul className="features">
                              <li>
                                <img
                                  ...
                                  alt=""
                                />{" "}
                                {car.mileage && car.mileage.match(/\d+/g)
                                  ? parseInt(
                                      car.mileage.match(/\d+/g)[0]
                            ...
                            <div className="content-btm">
                              ...
                              <div className="brand">
                                ...
                                >
                                  <a>
                                    <img
                                      src={`assets/img/home1/icon/${car.make}.svg`}
                                      alt="brand logo"
                                    />
                                  </a>
                                </Link>
